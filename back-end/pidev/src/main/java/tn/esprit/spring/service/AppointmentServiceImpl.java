...
public class AppointmentServiceImpl implements IAppointmentService {
	...
	public void Donnerrdv(long id) {
		...
		if (list1.size() != 0) {
			...
			msg = "Bonjour, /n"+ "votre rendez vous est planifier à " + Integer.toString(d.getTime())+"h /n Cordialement." ;
			...
			if (list2.size() == 0) {
				msg = "Bonjour, /n ce jour est indisponible vous pouvez choisir un autre jour. /n Cordialement ";
			}

			else {
				msg = "Bonjour, /n votre choix de disponibilité est impossible merci de le changer /n Cordialement.";
			}
		}
